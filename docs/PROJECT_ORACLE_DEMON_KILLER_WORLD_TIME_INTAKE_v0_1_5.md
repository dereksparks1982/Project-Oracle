# Demon Killer World-Time Intake — Project Oracle v0.1.5
...
| Demon Killer law | Oracle v0.1.5 adaptation |
| --- | --- |
...
| Catch-up lanes are explicit | v0.1.5 applies only world-clock catch-up; future events gain versioned lanes |
