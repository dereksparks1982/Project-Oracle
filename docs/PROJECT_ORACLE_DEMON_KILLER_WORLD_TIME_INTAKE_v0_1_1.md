# Demon Killer World-Time Intake — Project Oracle v0.1.1
...
| Demon Killer law | Oracle v0.1.1 adaptation |
| --- | --- |
...
| Catch-up lanes are explicit | v0.1.1 applies only world-clock catch-up; future events gain versioned lanes |
