# Demon Killer World-Time Intake — Project Oracle v0.1.0
...
| Demon Killer law | Oracle v0.1.0 adaptation |
| --- | --- |
...
| Catch-up lanes are explicit | v0.1.0 applies only world-clock catch-up; future events gain versioned lanes |
