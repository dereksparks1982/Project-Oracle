...
Project Oracle v0.1.0 is the first authorised C#/.NET console prototype candidate. It provides C# reference evidence for structured records, stable identities, modules, routines, collections, deterministic probability, exact real-time scaling, calendar and celestial state, atomic files, save validation, forward-only catch-up, protected World and Creator records, and behavioural tests.
