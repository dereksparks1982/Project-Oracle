...
| OR-FI-052 | Separate World, Creator, and inhabitant-knowledge logs | The World Record may be Creator-facing creation history; Adam and later inhabitants need separate knowledge/observation records so hidden truth does not leak into their decisions. | Structured logs with enforced information boundaries, not only formatted text. |
...
Project Oracle v0.1.1 is the first accepted installable C#/.NET console prototype after the unaccepted v0.1.0 SDK-pin failure. Project Oracle v0.1.2 adds the live-window launcher evidence future implementation will eventually need for separate tool surfaces. Project Oracle v0.1.3 adds direct address channels, seed-based living kinds, Adam's naming mandate, and Natural Course evidence. Project Oracle v0.1.4 adds legacy save compatibility evidence. Project Oracle v0.1.5 adds project-specific authority and no-guessing evidence through Oracle's own Company Bible. Project Oracle v0.1.6 adds physical function-key input evidence and save migration chain repair evidence. Project Oracle v0.1.7 adds priority event scheduler evidence and first offered-choice evidence. Project Oracle v0.1.8 remains manually rejected evidence. Project Oracle v0.1.9 adds live console refresh evidence, saved cosmology/world-power state, Creator-facing World Record evidence, and deterministic question-answer inspection evidence. The accepted C# reference already provides evidence for structured records, stable identities, modules, routines, collections, deterministic probability, exact real-time scaling, calendar and celestial state, atomic files, save validation, forward-only catch-up, protected World and Creator records, terminal interaction, and behavioural tests.

These C# capabilities expose or exercise OR-FI-001 through OR-FI-006, OR-FI-010, OR-FI-012, OR-FI-014, OR-FI-020, OR-FI-022, OR-FI-023, OR-FI-026, OR-FI-030, OR-FI-031, OR-FI-032, OR-FI-035, OR-FI-036, OR-FI-040, OR-FI-041, OR-FI-042, OR-FI-045, OR-FI-046, OR-FI-050, OR-FI-052, OR-FI-053, OR-FI-080, OR-FI-082, and OR-FI-083. They remain **Recorded**, not Accepted or Ported, until Derek assesses an exact accepted tag and owns any resulting language work.
