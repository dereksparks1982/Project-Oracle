...
**Current version:** v0.1.7 — Deterministic Event Queue and Offered Choices  
...
The intervention is queued first, then the event queue can make the vessel speak after its scheduled delay. Adam receives a minimal offered-choice record, but v0.1.7 deliberately executes no fruit effect, punishment, memory, belief, companion, expulsion, or full autonomous decision engine.
...
Warnings are errors. The validator restores, builds, runs thirty-seven acceptance checks, checks the Project Oracle Company Bible, and performs a console secrecy smoke test.
...
4. Read `docs/PROJECT_ORACLE_CANON_v0_1_7.md`.
5. Read `docs/PROJECT_ORACLE_ROADMAP_v0_1_7.md`.
