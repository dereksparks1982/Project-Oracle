namespace ProjectOracle.Lore;

public static class OracleLore
{
    public const string Monad = "Monad";
    public const string Wisdom = "Sophia / Wisdom";
    ...
    public const string OracleHidden = "No in-world being knows that Oracle exists unless Oracle deliberately reveals that truth. Oracle interventions reveal only what is actually manifested or perceived.";
    public const string OracleSerpentManifestation = "In Eden, Oracle manifested in the form of a clever serpent. Eve knew only the clever serpent and was never told Oracle's true identity.";

    public const string HumanoidFuture = "Future humanoid peoples may range from person-like forms to monstrous forms. Their origins, cultures, and histories are not prewritten.";
    public const string PlantOrigin = "The origin of plant life remains an open canon decision.";
    public const string AnimalOriginBoundary = "The exact origin of ordinary animals remains an open canon decision.";
    public const string LanguageBoundary = "The origin of language remains an open canon decision.";
    public const string Eden = "Eden / the Garden is a beautiful prison and containment environment when that later history actually comes into existence.";
}
